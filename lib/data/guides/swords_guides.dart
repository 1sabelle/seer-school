...
const swordsGuides = <CardGuide>[
  ...
  CardGuide(
    ...
    suitMeaning:
        'The Swords suit governs intellect, truth, and conflict, and in '
        'the Ace all of these themes exist as pure potential. This is the '
        'moment a new idea pierces through old confusion, offering both '
    ...
    reflectionQuestions: [
      ...
      'How can you wield honesty with both courage and compassion?',
    ],
  ),
  ...
  CardGuide(
    ...
    suitMeaning:
        'The Swords themes of intellect and truth are turned inward as '
        'avoidance. The conflict that Swords so often represents has been '
        'suppressed rather than resolved, and the mental clarity this suit '
    ...
    reflectionQuestions: [
      ...
      'What would change if you trusted yourself to handle the truth?',
    ],
  ),
  ...
  CardGuide(
    ...
    elementMeaning:
        ...
        'accept it.',
    suitMeaning:
        'Swords govern truth, and the Three reveals truth\'s sharpest '
        'edge: the kind that wounds on its way to healing. The conflict '
    ...
    reflectionQuestions: [
      ...
      'How might this heartbreak ultimately serve your growth?',
    ],
  ),
  ...
  CardGuide(
    ...
    reflectionQuestions: [
      ...
      'Are you confusing stillness with stagnation?',
    ],
  ),
  ...
  CardGuide(
    ...
    elementMeaning:
        ...
        'resentment.',
    suitMeaning:
        'The conflict inherent in the Swords suit reaches a destructive '
        'peak. The intellect that should serve truth has been bent toward '
        'winning at all costs, and the clarity Swords promise is clouded '
        'by ego and the bitter taste of a victory no one can enjoy.',
    numerologyMeaning:
        'Five is the number of challenge, disruption, and instability. '
        'In the Swords suit, the challenge is ethical: a test of whether '
    ...
    reflectionQuestions: [
      ...
      'What would it look like to walk away from a fight that isn\'t serving you?',
    ],
  ),
  ...
  CardGuide(
    ...
    suitMeaning:
        ...
        'wisdom of knowing when to leave. The truth this suit demands is '
        'not always dramatic; sometimes it is the quiet acknowledgment '
        'that a chapter has ended and staying would only deepen the wound.',
    numerologyMeaning:
    ...
    reflectionQuestions: [
      ...
      'Can you trust the journey even when the destination is not yet visible?',
    ],
  ),
  ...
  CardGuide(
    ...
    suitMeaning:
        'The Swords suit\'s connection to strategy and mental agility '
        'takes a morally grey turn. The sharp mind that can discern truth '
        'can also craft deception. This card asks whether your cleverness '
        'is serving justice or simply serving yourself.',
    numerologyMeaning:
  ...
  CardGuide(
    ...
    elementMeaning:
        ...
        'liberate has instead constructed an elaborate prison of anxiety, '
        'self-doubt, and catastrophic thinking.',
    suitMeaning:
    ...
    numerologyMeaning:
        ...
        'the Swords suit, the transformation required is internal: '
    ...
    reflectionQuestions: [
      ...
      'If you removed the blindfold, what would you actually see?',
    ],
  ),
  ...
  CardGuide(
    ...
    suitMeaning:
        'The Swords suit\'s intellectual intensity reaches its most '
        'painful expression. The mental acuity that serves so well in '
        'daylight becomes torment in the dark, as every worry is analysed, '
    ...
    reflectionQuestions: [
      ...
      'What would you say to a friend who was suffering the way you are right now?',
    ],
  ),
  ...
  CardGuide(
    ...
    elementMeaning:
        ...
        'lies an unexpected mercy: when the mind has nothing left to '
        'fear, a strange calm arrives.',
    suitMeaning:
    ...
    reflectionQuestions: [
      ...
      'What would it mean to surrender to this conclusion and begin again?',
    ],
  ),
  ...
  CardGuide(
    ...
    suitMeaning:
        'The Swords themes of intellect and truth are expressed as raw '
        'curiosity. The Page has discovered the power of the mind but is '
        'still learning to direct it. Every question leads to three more, '
    ...
    reflectionQuestions: [
      ...
      'Where could you benefit from a beginner\'s willingness to question everything?',
    ],
  ),
  ...
  CardGuide(
    ...
    suitMeaning:
        'The Swords suit\'s sharpness and drive for truth become an '
        'all-consuming charge. The Knight embodies the suit\'s most '
        'aggressive expression: intellect as a weapon, debate as combat, '
    ...
    reflectionQuestions: [
      ...
      'How can you harness your mental intensity without burning bridges?',
    ],
  ),
  ...
  CardGuide(
    ...
    elementMeaning:
        ...
        'clarity.',
    suitMeaning:
        'The Swords suit\'s quest for truth is tempered by emotional '
        'intelligence. The Queen wields the blade of honesty with '
    ...
    reflectionQuestions: [
      ...
      'What hard truth do you need to tell yourself with compassion?',
    ],
  ),
  ...
  CardGuide(
    ...
    elementMeaning:
        ...
        'ambition.',
    suitMeaning:
        'The Swords suit\'s themes of intellect, truth, and conflict '
        'find their most mature expression. The King has fought every '
    ...
    reflectionQuestions: [
      ...
      'How can you exercise authority without losing compassion?',
    ],
  ),
];
